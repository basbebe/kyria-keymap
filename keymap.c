 ...
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┬──────┐  ┌──────┬──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │LSFT ⇧│  F   │MT_RA_│  L   │  D   │  P   │CAPS_W│ NAV  │  │ NUM  │ TAB  │  J   │  U   │  O   │MT_RA_│  K   │ - _  │
 * └──────┴──────┴──────┼──────┼──────┼──────┼──────┼──────┤  ├──────┼──────┼──────┼──────┼──────┼──────┴──────┴──────┘
 *                      │ MUTE │LGUI ◆│ TAB  │OSS_NU│REP_AD│  │BSP_FU│SPC_NA│ SYM  │ BSPC │ MUTE │
 *                      │      │      │      │      │      │  │      │      │      │      │      │
 *                      └──────┴──────┴──────┴──────┴──────┘  └──────┴──────┴──────┴──────┴──────┘
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        XXXXXXX, KC_Z,    KC_W,    KC_C,    KC_B,    KC_V,                                        KC_X,    KC_MINS, KC_QUOT, KC_DOT,  KC_Q,    XXXXXXX,
        KC_LALT, HOME_S,  HOME_N,  HOME_R,  HOME_T,  KC_G,                                        KC_Y,    HOME_I,  HOME_E,  HOME_A,  HOME_H,  KC_QUOT,
        KC_LSFT, KC_F,    MT_RA_M, KC_L,    KC_D,    KC_P,  CAPS_WORD, NAV,     NUM,     KC_TAB,  KC_J,    KC_U,    KC_O,    MT_RA_CM,KC_K,    KC_MINS,
                                   KC_MUTE, KC_LGUI, KC_TAB,  OSS_NUM, REP_ADJ, BSP_FUN, SPC_NAV, SYM,     KC_BSPC, KC_MUTE
    ),
/* ┌──────┬──────┬──────┬──────┬──────┬──────┐                              ┌──────┬──────┬──────┬──────┬──────┬──────┐
 ...
 *                                                                               generated by [keymapviz] */
    [_SYM] = LAYOUT(
      _______, ELLIPS,  KC_AT,   KC_LBRC, KC_RBRC, KC_CIRC,                                     KC_PLUS, KC_LABK, KC_RABK, KC_EXLM, PARAGPH, _______,
      _______, KC_BSLS, KC_SLSH, KC_LCBR, KC_RCBR, KC_ASTR,                                     KC_EQL,  KC_LPRN, KC_RPRN, KC_COLN, KC_SCLN, _______,
      _______, KC_HASH, KC_DLR,  KC_PIPE, KC_TILD, PARAGPH, _______, _______, _______, _______, EURO,    KC_PERC, KC_AMPR, KC_QUES, KC_GRV,  _______,
 ...
 *                                                                               generated by [keymapviz] */
    [_NUM] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_1,    KC_2,    KC_3,    KC_PEQL, _______,
