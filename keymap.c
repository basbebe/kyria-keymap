 ...
 * │      │  J   │  W   │  M   │  G   │  P   │                              │  X   │ . •  │ ' "  │  Z   │  Q   │      │
 * ├──────┼──────┼──────┼──────┼──────┼──────┤                              ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │ OS-⎈ │ S/⎈  │ N/⎇  │ R/⇧  │ T/◆  │  C   │                              │  Y   │ I/◆  │ E/⇧  │ A/⎇  │ H/⎈  │ OS-⎈ │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┬──────┐  ┌──────┬──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ OS-◆ │  V   │MT_RA_│  L   │  D   │  B   │CAPS_W│SWAPHN│  │SWAPHN│ ESC  │ - /  │  U   │  O   │MT_RA_│  K   │ OS-◆ │
 * └──────┴──────┴──────┼──────┼──────┼──────┼──────┼──────┤  ├──────┼──────┼──────┼──────┼──────┼──────┴──────┴──────┘
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        XXXXXXX, KC_J,    KC_W,    KC_M,    KC_G,    KC_P,                                          KC_X,    KC_DOT,  KC_QUOT, KC_Z,    KC_Q,    XXXXXXX,
        OS_LCTL, HOME_S,  HOME_N,  HOME_R,  HOME_T,  KC_C,                                          KC_Y,    HOME_I,  HOME_E,  HOME_A,  HOME_H,  OS_RCTL,
        OS_LGUI, KC_V,    MT_RA_F, KC_L,    KC_D,    KC_B,    CAPS_WORD, SH_OS,   SH_OS,   KC_ESC,  KC_MINS, KC_U,    KC_O,    MT_RA_CM,KC_K,    OS_RGUI,
 ...
 *                                                                               generated by [keymapviz] */
    [_SYM] = LAYOUT(
      _______, ELLIPS,  KC_AT,   KC_PIPE, KC_TILD, PARAGPH,                                     EURO,    KC_EXLM, KC_CIRC, KC_GRV,  _______, _______,
