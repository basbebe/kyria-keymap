 ...
 * │      │  Z   │  W   │  C   │  B   │  V   │                              │  X   │ - _  │ ' "  │ . •  │  Q   │      │
 * ├──────┼──────┼──────┼──────┼──────┼──────┤                              ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │ OS-⎈ │ S/⎈  │ N/⎇  │ R/⇧  │ T/◆  │  G   │                              │  Y   │ I/◆  │ E/⇧  │ A/⎇  │ H/⎈  │ OS-⎈ │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┬──────┐  ┌──────┬──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ OS-◆ │  F   │MT_RA_│  L   │  D   │  P   │CAPS_W│SWAPHN│  │SWAPHN│ TAB  │  J   │  U   │  O   │MT_RA_│  K   │ OS-◆ │
 * └──────┴──────┴──────┼──────┼──────┼──────┼──────┼──────┤  ├──────┼──────┼──────┼──────┼──────┼──────┴──────┴──────┘
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        OS_LCTL, HOME_S,  HOME_N,  HOME_R,  HOME_T,  KC_G,                                        KC_Y,    HOME_I,  HOME_E,  HOME_A,  HOME_H,  OS_RCTL,
        OS_LGUI, KC_F,    MT_RA_M, KC_L,    KC_D,    KC_P,  CAPS_WORD, SH_OS,   SH_OS,   KC_TAB,  KC_J,    KC_U,    KC_O,    MT_RA_CM,KC_K,    OS_RGUI,
